	             ...
	             <div class="kt-portlet__head-toolbar">
	                <div class="kt-portlet__head-wrapper">
	                    <div class="kt-portlet__head-actions">
	                        <a href="<?php echo base_url() ?>admin_user_add" class="btn btn-brand btn-elevate btn-icon-sm new_btn" data-toggle="modal" data-target="#add_edit_state">
	                            <i class="la la-plus"></i>New State
	                        </a>
	                    </div>  
	                </div>      
	            </div>
        	...
        	<div class="kt-portlet__body">
               ...
               <!--  <div class="alert alert-success alert-dismissible success_msg" style="display:none">
	            ...
	            <table class="table table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inline" id="admin_list" role="grid" aria-describedby="kt_table_1_info">
	                ...
	                <tbody>
	                	<?php $i=1; foreach($state_list AS $key=>$val) { ?>
...
<div class="container"> 
    ...
    <div class="modal fade" id="add_edit_state" role="dialog">
        <div class="modal-dialog"> 

        <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title state_title">Add State</h4>
                    <button type="button" class="close" data-dismiss="modal"></button>
                </div>
                <div class="view_contain" style="padding: 20px;">
         			<form class="kt-form" id="add_edit_admin_user">
         				<input type='hidden' class="state_id" value=""/>
         				<div class="form-group row">
							<div class="col-lg-12">
								<label class="col-form-label">* State Name:</label>
								<input type="text" name="state_name" class="form-control state_name" placeholder="Enter state name" value="" required>
						...
						<div class="row">
							<div class="col-lg-6">
								<button type="submit" class="btn btn-success save_state">Save</button>	
							</div>
						</div>
...
<script type="text/javascript">
	...
	$(function() {
        $('#admin_list').dataTable({"aaSorting": []});
        ...
        $(document).on('click', '.save_state', function(){
    		...
    		if(state_name == ''){
    			$('.state_msg').html('Required state name');
    			setTimeout(function(){
					$('.state_msg').slideUp(); 
