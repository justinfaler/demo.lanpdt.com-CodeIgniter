...
<!-- begin:: Footer -->
					<div class="kt-footer kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop" id="kt_footer">
						<div class="kt-footer__copyright">
							2020&nbsp;&copy;&nbsp;<a href="#" target="_blank" class="kt-link">CPA2GO</a>
						</div>
		...
		<script src="<?=base_url()?>assets/vendors/general/select2/dist/js/select2.min.js" type="text/javascript"></script>
