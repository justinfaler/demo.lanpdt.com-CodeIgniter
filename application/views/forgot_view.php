				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-12 text-center">
					<div class="login_signup">
						<div class="ls_div text-center">
							<!-- Content Title -->
							<div class="ls_title">
								<h2 class="sub_title">Reset Password</h2>
							...
							<div class="ls_form form_div">
								...
								<form action="#" id="forgot_password_data" method="post">
									...
									<div class="ls_button_div button col-lg-12 col-md-12 col-sm-12 col-12 text-left p-0">
										<button type="submit" class="ls_button ls_button button btn col-lg-12 col-md-12 col-sm-12 col-12 text-center text-uppercase">RESET PASSWORD</button>
									</div>
								</form>
