! function(e, t) {
    ...
    return function(e) {
        ...
        if (i.regeneratorRuntime = void 0, e.exports = n(25), a) i.regeneratorRuntime = r;
        else try {
        ...
        var g = new function() {
            ...
            ee = function(e, t, n) {
                ...
                var a = 0,
                    ...
                    d = function(e) {
                        if (a++, c)
                            if (c === e) r.default.debug("Using Video Source/ Audio Source");
                            else {
                    ...
                    l = function() {
                        ...
                        if (r.default.debug("GetUserMedia", JSON.stringify(t)), navigator.mediaDevices && navigator.mediaDevices.getUserMedia) navigator.mediaDevices.getUserMedia(t).then(d).catch(u);
        ...
        var Re = function(e) {
                ...
                return t.videoSize = [640, 480, 640, 480], void 0 !== e.local && !0 !== e.local || (t.local = !0), t.initialized = !t.local, t._streamInitID = null,
                    function(e) {
                        e.audioMixing = {
                            ...
                            c.open("GET", n, !0), c.responseType = "arraybuffer", c.onload = function() {
                                if (c.status > 400) s("".concat(c.status, " ").concat(c.statusText));
                                else {
                                    var n = c.response;
                            ...
                            if (e.audioMixing.buffer[t.id]) {
                                ...
                                if (a.connect(s), s.connect(e.audioMixing.mediaStreamDest), a.gainNode = s, t.loop) a.loop = !0, a.start(0, t.playTime / 1e3);
                                else if (t.cycle > 1)
                            ...
                            if (s.state === e.audioMixing.states.IDLE) {
                                ...
                                if (_e(a) && (t.cacheResource = !0), s.state = e.audioMixing.states.STARTING, s.options = t, e.audioMixing.buffer[t.filePath]) {
                                    ...
                                    if (i) s.state = e.audioMixing.states.IDLE, n ? n(i) : r.default.error("[".concat(e.streamId, "] "), i);
                                    else {
                    ...
                    function(e, t) {
                        ...
                        var e, n = o.b.reportApiInvoke(t.sid, {
                        ...
                        if (ce(e, "elementID"), _e(n) || (_e(n.fit) || oe(n.fit, "fit", ["cover", "contain"]), _e(n.muted) || ue(n.muted, "muted")), t.player) r.default.warning("[".concat(t.streamId, "] Stream.play(): Stream is already playing. Fallback to resume stream")), t.resume().then(function() {
                            ...
                            t.on("player-status-change", function e(n) {
                                if (s[n.mediaType] = n, s.audio && s.video)
                                    if (t.removeEventListener("player-status-change", e), s.video.isErrorState || s.audio.isErrorState) {
            ...
            Me = function(e) {
                ...
                t.needReconnect = !0, t.isTimeout = !1, t.isInit = !0, t.sendbytes = 0, t.recvbytes = 0, t.startTime = Date.now(), t.lastMsgTime = null, t.clientId = e.clientId, t.hostIndex = 0, t.requestID = 0, e.host instanceof Array ? t.host = e.host : t.host = [e.host], t.getSendBytes = function() {
                    ...
                    if (t.needReconnect = !0, r.default.debug("[" + t.clientId + "] start connect:" + t.host[t.hostIndex]), t.lts = (new Date).getTime(), t.connection = new WebSocket("wss://" + t.host[t.hostIndex]), t.connection.binaryType = "arraybuffer", t.turnConfig = {}, t.connection.url) {
                        ...
                        if (n) t.turnConfig.url = n[1], Object(a.getParameter)("TURN_ENABLE_TCP") && (t.turnConfig.tcpport = parseInt(n[2]) + 30), Object(a.getParameter)("TURN_ENABLE_UDP") && (t.turnConfig.udpport = parseInt(n[2]) + 30);
                        else {
                            ...
                            Ge({
                                ...
                                function(e, t, n) {
                                    ...
                                    var g = setTimeout(function() {
                                        if (!s)
                                            for (var t = Object(a.getParameter)("WEBCS_DOMAIN_BACKUP_LIST"), n = 0; n < t.length; ++n)
            ...
            Xe = function(e, t, n) {
                Date.now();
                var o, s = Object(a.getParameter)("ACCOUNT_REGISTER"),
                    c = !1,
        ...
        var at = function e(t) {
                ...
                b.p2pCounter = Object(te.f)(1e5), b.generateP2PId = function() {
                    ...
                    if (n) r.default.error("[".concat(b.clientId, "] "), n);
                    else {
                        ...
                        if (b.p2ps.set(p, e), e.p2pId = p, void 0 !== e.url) N(m({
                            ...
                            var f = function() {
                                Object(a.getParameter)("REPORT_STATS") && e && e.pc && e.pc.getVideoRelatedStats && e.pc.getVideoRelatedStats(function(t) {
                                    var n, i, o = b.socket && b.socket.getLastMsgTime() && Date.now() - b.socket.getLastMsgTime();
                ...
                var C = function(e, t) {
                    ...
                    O = function(e, t, i) {
                        if (b.onConnect = t, b.socket) {
                            if (b.dispatchEvent({
                                    type: "reconnect"
                                }), "retry" === b.reconnectMode) r.default.debug("[".concat(b.clientId, "] Retry current gateway")), b.socket.reconnect();
                            else if ("tryNext" === b.reconnectMode) r.default.debug("[".concat(b.clientId, "] Try next gateway")), b.socket.connectNext();
                                ...
                                case 4:
                                    c.connection = n, c.status = mt, c._flush(), c.startPingpong(), n.addEventListener("close", function(e) {
                                        ...
                                        if (e.data) {
                                            ...
                                            if (t.requestId)
                                                for (var n = c.requests.length - 1; n >= 0; n--) {
                                                    var i = c.requests[n];
        ...
        var Ct = function(e) {
            ...
            Nt = function(e) {
                ...
                return t.aespassword = null, t.aesmode = "none", t.hasPublished = !1, t.getSessionId = function() {
                        ...
                        var n = Object(te.b)();
                        if (r.default.debug("renewSession ".concat(e.sessionId, " => ").concat(n)), e.sessionId = n, t.joinInfo && (t.joinInfo.sid = n), t.gatewayClient && (t.gatewayClient.joinInfo && (t.gatewayClient.joinInfo.sid = n), t.gatewayClient.localStreams))
                        ...
                        return t.gatewayClient = e, t.exceptionMonitor = new ut(e), t.localStats = {}, t.remoteStats = {}, t.session = {
                            ...
                            var n = 0,
                                i = 0;
                            if (!e || !t) return !1;
                            if (Object(f.isChrome)() || Object(f.isOpera)()) n = e.googFrameRateInput, i = e.googFrameRateSent;
                            else if (Object(f.isSafari)()) n = parseInt(e.framerateMean), i = parseInt(e.framesEncoded) - parseInt(t.framesEncoded);
                            else {
                            ...
                            var n = 0,
                                i = 0;
                            if (!e || !t) return !1;
                            if (Object(f.isChrome)() || Object(f.isOpera)()) n = e.googFrameRateReceived, i = e.googFrameRateDecoded;
        ...
        t.default = {
            ...
            createClient: function(e) {
                ...
                return r.default.info("Creating client, MODE: ".concat(e.mode, " CODEC: ").concat(e.codec)),
                    function(e) {
                        switch (e.mode) {
                            case "interop":
                            case "h264_interop":
